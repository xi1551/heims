<template>
  <div class="page-container">
    <div class="page-header">
      <span class="title">护士管理</span>
      <el-button type="primary" :icon="Plus" @click="handleAdd">新增护士</el-button>
    </div>
...
import { getPage, remove } from '../api/nurse'
...
const handleDelete = (row) => {
  ElMessageBox.confirm(`确定要删除护士"${row.name}"吗？`, '提示', {
